...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 1990-2019 <a
                href="https://weibo.com/yijiecaomin900316">酷酷的易先生</a>.
    ...
    function del() {
        ...
        for (var i = 0; i < $check.length; i++) {
            if ($check[i].checked == true) {//选中
                id_array.push($check[i].value);
            }
        }
        window.location.href = "${pageContext.request.contextPath}/product/productDel.do?id=" + id_array;
    }
